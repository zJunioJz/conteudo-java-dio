package poo.pratica.desafioCinco;
...
public class SistemaAcionistas {
    public List<String> obterAnalisesDesempenho(String dataInicialStr, String dataFinalStr) throws ParseException {
        ...
        // Percorra a lista de análises e verifique se a data está dentro do período especificado.
        for (Analise analise : analises) {
            Date dataAnalise = analise.getData();
            if ((dataAnalise.equals(dataInicial) || dataAnalise.after(dataInicial)) &&
                    (dataAnalise.equals(dataFinal) || dataAnalise.before(dataFinal))) {
